...
Sample <- c("B1/BMP o.e CAF", "B2/BMP o.e CAF", "B1/BMP o.e CAF-FOXA1 k.o tumour", "B2/BMP o.e CAF-FOXA1 k.o tumour")
...
pdf("Extended_Figure10/image/Extended_Fig10i.pdf", width=19, height=5)
